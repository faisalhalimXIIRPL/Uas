    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card card-info">
          ...
          <form class="" method="post" action="<?php echo base_url('keluarga/simpan_anggota_keluarga') ?>" >
            <div class="card-body">
              <div class="row">
                <div class="col-3">
              ...
              <div class="row">
                ...
                <div class="col-3">
                  ...
                  <select class="form-control" name="golongan_darah" placeholder="Golongan Darah">
                    <option value="">- Pilih -</option>
              ...
              <div class="row">
                ...
                <div class="col-4">
                  ...
                  <select class="form-control" name="status_keluarga" placeholder="Status Keluarga">
                    <option value="">- Pilih -</option>
                ...
                <div class="col-3">
                  ...
                  <select class="form-control" name="kewarganegaraan" placeholder="Kewarganegaraan">
                    <option value="">- Pilih -</option>
            ...
            <div class="card-footer">
              <input type="submit" class="btn btn-sm btn-primary float-right" name="simpan" value="Simpan">
